# Generated by Django 2.1.7 on 2019-07-11 21:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lab.Area')),
                ('gender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lab.Gender')),
            ],
            options={
                'db_table': 'artist',
            },
        ...
        migrations.AddField(
            model_name='artist',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lab.ArtistType'),
        ),
