# Generated by Django 2.1.7 on 2019-07-16 17:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(db_column='area', on_delete=django.db.models.deletion.CASCADE, to='lab.Area')),
                ('gender', models.ForeignKey(blank=True, db_column='gender', null=True, on_delete=django.db.models.deletion.CASCADE, to='lab.Gender')),
            ],
            options={
                'db_table': 'artist',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lab.Artist')),
                ('artist_credit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lab.ArtistCredit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recording', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lab.Recording')),
            ],
            options={
                'db_table': 'track',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edits_pending', models.IntegerField()),
                ('last_updated', models.DateTimeField(blank=True, null=True)),
                ('artists', models.ManyToManyField(null=True, through='lab.ArtistWork', to='lab.Artist')),
            ],
            options={
                'db_table': 'work',
            },
        ...
        migrations.AddField(
            ...
            name='work',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='lab.Work'),
        ),
        ...
        migrations.AddField(
            ...
            name='artist',
            field=models.ManyToManyField(through='lab.ArtistCreditName', to='lab.Artist'),
        ),
        migrations.AddField(
            model_name='artist',
            name='type',
            field=models.ForeignKey(blank=True, db_column='type', null=True, on_delete=django.db.models.deletion.CASCADE, to='lab.ArtistType'),
        ),
        migrations.AlterUniqueTogether(
            name='artistcreditname',
